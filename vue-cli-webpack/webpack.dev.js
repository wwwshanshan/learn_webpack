/*  通过 vue inspect --mode=production > webpack.prod.js
    将vue生产环境配置打包一起放在webpack.prod.js文件下面，
    生产环境代码只需要研究webpack.prod.js文件即可
*/
module.exports = {
  mode: 'development',
  context: '/',
